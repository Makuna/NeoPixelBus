...
public:
    ...
    void Initialize()
    {
        ...
        for (indexDesc = 0; indexDesc < (_i2sBufDescCount - 2); indexDesc++)
        {
            ...
            _i2sBufDesc[indexDesc].buf_ptr = static_cast<uint32_t>(is2Buffer);
            _i2sBufDesc[indexDesc].unused = 0;
            _i2sBufDesc[indexDesc].next_link_ptr = static_cast<uint32_t>(&(_i2sBufDesc[indexDesc + 1]));
        ...
        for (; indexDesc < _i2sBufDescCount; indexDesc++)
        {
            ...
            _i2sBufDesc[indexDesc].buf_ptr = static_cast<uint32_t>(_i2sZeroes);
            _i2sBufDesc[indexDesc].unused = 0;
            _i2sBufDesc[indexDesc].next_link_ptr = static_cast<uint32_t>(&(_i2sBufDesc[indexDesc + 1]));
        }
        ...
        _i2sBufDesc[indexDesc - 1].next_link_ptr = static_cast<uint32_t>(&(_i2sBufDesc[indexDesc - 2]));
            ...
            case NeoDmaState_Pending:
                {
                    ...
                    (finished_item + 1)->next_link_ptr = static_cast<uint32_t>(s_this->_i2sBufDesc);
            ...
            case NeoDmaState_Sending:
                {
                    ...
                    (finished_item + 1)->next_link_ptr = static_cast<uint32_t>(finished_item);
