/*-------------------------------------------------------------------------
SM16716ColorFeatures provides feature classes to describe color order and
color depth for NeoPixelBus template class when used with SM16716s
Written by Michael C. Miller.

Support for SM16716 by Ivo H adapted from P9813
...
class SM16716Elements
{
public:
    static const size_t PixelSize = 3; //requires 3 to be sent
...
class SM16716ElementsNoSettings : public SM16716Elements
{
public:
...
class SM16716RgbFeature : public SM16716ElementsNoSettings
{
public:
